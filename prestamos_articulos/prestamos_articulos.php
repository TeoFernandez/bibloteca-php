...
?>
    <h1>Prestamos Articulos</h1>
    <p>Bienvenido a la sección de préstamos. En esta sección podrás gestionar los préstamos de Articulos.</p>
    <div class="btn-agregar-prestamo-articulo">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#miModal">Agregar Prestamo</button>
    </div>
    <div>
        <table id="prestamos_articulos" class="display" style="width:100%">
            <thead>
                <tr>
                ...
                <div>
                    <form>
                        <div>
                            ...
                            <input type="hidden" id="id_prestamos_articulos" name="id_prestamos_articulos">
                            <div class="mb-3">
                                <label for="id_articulo">Articulo</label>
                                <select id="id_articulo" name="id_articulo" class="form-control" required></select>
                            </div>
                            <div class="mb-3">
    ...
    <script src="js/prestamos_articulos.js"></script>
